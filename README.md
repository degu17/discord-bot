# Discord Bot - Hit&Blow ゲーム & タスク管理

Discord上でHit&Blowゲームとタスク管理機能を提供するTypeScript製のボットです。
